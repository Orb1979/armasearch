...
/**This class is a utility for finding the String based upon the wild card pattern.
 * For example if the actual String "John" and your wild card pattern is "J*", it will return true.
